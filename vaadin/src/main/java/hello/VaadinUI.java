...
public class VaadinUI extends UI {
    ...
    private final MeasurementsView measurementsView;
    @Autowired
    public VaadinUI(CustomerRepository repo, CustomerEditor editor, MeasurementsView measurementsView) {
        this.repo = repo;
        this.editor = editor;
    ...
    protected void init(VaadinRequest request) {
        ...
        VerticalLayout mainLayout = new VerticalLayout(actions, grid, editor, measurementsView);
